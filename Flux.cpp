...
Real flux(ComplexHMatrix &ZLU, Vector3 &j, GreensFunction *green, const Point &p, RWGTree *rwgTree, RWGTree *t, GreensFunction *greenExt, Progress &progress, Options &options)
{
  SourceSet sources;
