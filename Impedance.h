...
ComplexDenseMatrix *ZtsNcross(RWGTree *t, RWGTree *s, GreensFunction *gExt, Options &options);
ComplexDenseMatrix *ZtsDot(RWGTree *t, RWGTree *s, GreensFunction *gExt, Options &options);
